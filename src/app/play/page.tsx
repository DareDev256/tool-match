...
export default function PlayPage() {
  const [queue, setQueue] = useState<ToolMatchItem[]>(() => shuffle(items).slice(0, 10));
    ...
    return (
      <main className="min-h-screen flex items-center justify-center p-6">
        <VictoryScreen
          ...
          speedLabel="Time (s)"
          onPlayAgain={() => { setQueue(shuffle(items).slice(0, 10)); setIdx(0); setScore(0); setCombo(0); setDone(false); setTaskStart(Date.now()); startTracking(); }}
